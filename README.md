[![Run App Strumberger, Hugh](https://github.com/hstrumberger/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/hstrumberger/GithubActions/actions/workflows/ci.yml)
